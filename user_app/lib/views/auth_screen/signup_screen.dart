      ...
      body: Center(child: Column(children: [
        ...
        Column(
          children: [
            ...
            5.heightBox,
            customTextField(hint: "Enter phone number",title: "Phone",controller: phoneController,isPass: false),
            5.heightBox,
              ...
              ourButton(() async {
                if(isCheck!=false)
                {
                  if(passwordController.text.toString().length < 6)
                      ...
                      else if(phoneController.text.toString() == "")
                      {
                          VxToast.show(context, msg: "Please fill up all field");
                      }
                      else{
                                        try {
