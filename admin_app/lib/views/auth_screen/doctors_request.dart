import 'package:admin_app/views/auth_screen/info.dart';
...
class _AllDoctorState extends State<doctorRequest> {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          StreamBuilder(
            stream: FirestoreServices.getDoctorRequest(),
                ...
                child: Padding(
                  ...
                  itemBuilder: (context,index){
                    ...
                    return GestureDetector(
                      onTap: (){
                                      Get.to(()=> doctor_info(data: ddata2,));
                                    },
                      child: Column(
